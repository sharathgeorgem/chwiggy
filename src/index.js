...
let receive = fetch('http://localhost:8000/items')
  .then(response => response.json())
  .then(res => {
    initialState.stock = res.menu
    console.log('The init state is ', initialState.stock)
  })
...
const initialState = {
  ...
  stock: [
    ...
    //   price: 34.95,
    //   img: 'https://www.walkaboutflorence.com/sites/default/files/styles/news_detail/public/Coffee_Caffe__Cappuccino_Latte_Florence_Italy.jpg'
    // }, {
    //   id: 1,
    //   name: 'TC 2017 Shorts',
